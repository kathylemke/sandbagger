  ...
  if (step === 3) {
    return (
      <ScrollView style={s.container} contentContainerStyle={{ padding: 16 }}>
        ...
        {/* Drill note for practice rounds */}
        {roundType === 'practice' && (
          <View style={{ marginTop: 16, backgroundColor: '#fef3c7', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#f59e0b' }}>
            <Text style={{ fontSize: 13, color: '#92400e', fontWeight: '600' }}>ℹ️ If you were doing a drill round, use the Training tab instead.</Text>
            <TouchableOpacity style={{ marginTop: 8 }} onPress={() => router.push('/(tabs)/training')}>
              <Text style={{ fontSize: 13, color: colors.gold, fontWeight: '700' }}>Go to Training Tab →</Text>
            </TouchableOpacity>
          </View>
        )}
