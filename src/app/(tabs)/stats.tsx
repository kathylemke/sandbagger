...
function PetalChart({ missCounts, totalShots, onTargetCount, title }: { missCounts: Record<string, number>; totalShots: number; onTargetCount: number; title?: string }) {
  ...
  return (
    <View style={{ alignItems: 'center', marginBottom: 16 }}>
      ...
      <Text style={{ fontSize: 12, color: colors.gray, fontStyle: 'italic', textAlign: 'center', padding: 8 }}>Shot dispersion chart (text view){onTargetCount > 0 ? ` — On target ${onTargetCount}` : ''}</Text>
...
function PuttPetalChart({ shots }: { shots: any[] }) {
  ...
  return (
    <View style={{ alignItems: 'center', marginBottom: 16 }}>
      ...
      <Text style={{ fontSize: 12, color: colors.gray, fontStyle: 'italic', textAlign: 'center', padding: 8 }}>Putt dispersion chart (text view) — Made: {madeCount}</Text>
